<div class="">
    ...
    <button class="btn modal-trigger blue-grey" href="#unityhassection"><i class="material-icons right"><div class="chip" ><img src="img/section.png" alt="Contact Person"></div></i><i class="material-icons right">keyboard_tab</i>UNIT AS SECTION</button>
                ...
                <div class="col s12 m8 l5">
                  <div class="card blue-grey lighten-5 z-depth-3">
                    <div class="card-content left-align">
                        <p><input type="checkbox" id="selectunity<?php echo $i?>"/>
                        <label for="selectunity<?php echo $i?>">Select </label></p>
                      <span class="card-title"><strong><?php echo $filunity->unityname ?></strong></span>
                    ...
                    <div class="card-action">
                      <button class="modal-trigger btn waves-effect waves-green white lighten-3 black-text" id="btneditunittable<?php echo $i ?>" style="cursor: pointer;" href="#ModalEditunit<?php echo $i ?>" data-tooltip="Edit Unit"><i class="material-icons right">edit</i>Edit </button>
                      <button class="btn modal-trigger waves-effect waves-red  white red-text" id="btnunitydeletemodal<?php echo $i ?>" style="cursor: pointer;" href="#Modal_delete_unity<?php echo $i ?>" data-tooltip="Delete Class"><i class="material-icons right">delete</i>Delete </button>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('input#unityname, textarea#descriptionunitycenter, textarea#descriptionunityleft,textarea#descriptionunityright').characterCounter();
        $('.modal').modal();
